...
export const THEMES: ThemeOption[] = [
  ...
  { id: 'monokai-pro-ristretto', label: 'Monokai Pro Ristretto' },
  { id: 'monokai-pro-octagon', label: 'Monokai Pro Octagon' },
  { id: 'vira-teal', label: 'Vira Teal' },
  { id: 'vira-ocean', label: 'Vira Ocean' },
